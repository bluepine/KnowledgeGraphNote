...
math_notes = [
    Concept("radon measure",
            ...
            raw"a radon measure is a Borel measure that is finite on compact sets."
            ),
    ...
    Concept("Borel measure",
            ...
            raw"if f is the borel sigma-algebra on some topological space, then a measure m:f->r is said to be a borel measure (or borel probability measure). for a borel measure, all continuous functions are measurable."
            ),
    ...
    Concept("borel sigma-algebra",
            ...
            raw"a sigma-algebra which is related to the topology of a set. the borel sigma-algebra is defined to be the sigma-algebra generated by the open sets (or equivalently, by the closed sets)."
            ),
...
These axioms are designed so that the traditional definitions of open and closed intervals of the real line continue to be true. For example, the restriction in (3) can be seen to be necessary by considering  $\cap_{n=1}^{\infty}(-1/n,1/n)={0}$, where an infinite intersection of open intervals is a closed set.
